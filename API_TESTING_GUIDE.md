...
## Base URL
```
http://localhost/Pd_backend/api/school
```
...
```json
{
  ...
  "user": {
    ...
    "mobile": "9876543210",
    "role_name": "admin",
    "profile_image": "users/profile.jpg"
  }
}
```
...
```bash
# Example: Login
curl -X POST http://localhost/Pd_backend/api/school/login \
  -H "Content-Type: application/json" \
  -d '{"mobile_no":"9876543210","password":"password123"}'

# Example: Get All Teachers
curl -X GET http://localhost/Pd_backend/api/school/getAllTeachers
```

### Using Postman
1. Import this file as a collection
2. Set base URL: `http://localhost/Pd_backend/api/school`
